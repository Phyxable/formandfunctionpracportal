...
class SignInPage extends Component {
  render() {
    ...
    <div className='futura-24-900 margin-top-64 '>
    Practitioner Portal
    </div>
     <div className="margin-top-16 futura-20-300">
     LOGIN 
    </div>
  ...
  render() {
    ...
    return (
      <form onSubmit={this.onSubmit} className="si-form margin-top-16">
        ...
        />
        <button disabled={isInvalid} type="submit signin-btn" className="button margin-top-16">
          Sign In
        </button>
        <SignUpLink />
